...
const decoders = {
	async oga(buf) {
		...
		if (!decoder) {
			let { OggVorbisDecoder } = await Promise.all(/* import() */[__webpack_require__.e(482), __webpack_require__.e(599), __webpack_require__.e(877)]).then(__webpack_require__.bind(__webpack_require__, 4599))
	...
	async mp3(buf) {
		...
		if (!decoder) {
			const { MPEGDecoder } = await Promise.all(/* import() */[__webpack_require__.e(404), __webpack_require__.e(922)]).then(__webpack_require__.bind(__webpack_require__, 96404))
	...
	async flac(buf) {
		...
		if (!decoder) {
			const { FLACDecoder } = await Promise.all(/* import() */[__webpack_require__.e(482), __webpack_require__.e(626)]).then(__webpack_require__.bind(__webpack_require__, 20119))
	...
	async opus(buf) {
		...
		if (!decoder) {
			const { OggOpusDecoder } = await Promise.all(/* import() */[__webpack_require__.e(482), __webpack_require__.e(120), __webpack_require__.e(273)]).then(__webpack_require__.bind(__webpack_require__, 28120))
	...
	async wav(buf) {
		...
		if (!decode) {
			let module = await __webpack_require__.e(/* import() */ 966).then(__webpack_require__.t.bind(__webpack_require__, 93966, 19))
	...
	async qoa(buf) {
		...
		if (!decode) {
			decoders.qoa.decode = decode = (await __webpack_require__.e(/* import() */ 374).then(__webpack_require__.bind(__webpack_require__, 9374))).decode
		}
		return buf && createBuffer(await decode(buf))
	}
}
